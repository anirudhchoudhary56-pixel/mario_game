...
cactus_img = pygame.image.load('cactus_bricks.JPEG')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('fire_bricks.JPEG')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('dragon.JPEG')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('fireball.JPEG')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('maryo.JPEG')
...
def game_over():
    ...
    game_over_img = pygame.image.load('end.JPEG')
